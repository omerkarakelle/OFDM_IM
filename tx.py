...
class tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_sink_0.set_center_freq(1200e6, 0)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/user/Masaüstü/OFDM_IM/tx_samples.iq', True, 0, 0)
